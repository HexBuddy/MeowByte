...
| [RFC Quick Links](https://en.wikipedia.org/wiki/List\_of\_RFCs#Topical\_list) | This Wikipedia article contains a large list of protocols tied to the RFC that explains their implementation. |
